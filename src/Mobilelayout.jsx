        ...
        <div className="flex flex-col gap-y-4 justify-center">
         ...
         {/* Name + Profession */}
          ...
          <a href="mailto:mattiasl380@gmail.com" className="flex flew-row items-center cursor-pointer fade-in hover:no-underline" style={{ animationDelay: '100ms'}}>
            ...
            <svg className='mx-[2px] self-center h-[1em] w-[1em]' xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 256 256"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>
          </a>
        </div>
      </div>
